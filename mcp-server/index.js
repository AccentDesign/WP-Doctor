  ...
  return {
    tools: [
      ...
      },
      {
        name: "wp_doctor_info",
        description:
          "Get WordPress installation information including version, PHP version, active theme, plugins count, and debug settings.",
        inputSchema: {
          type: "object",
          properties: {
            path: {
      ...
      {
        name: "wp_doctor_preview_fixes",
        description:
          "Preview available auto-fixes for detected issues without applying them. Shows what would change.",
        inputSchema: {
          type: "object",
          properties: {
            path: {
            ...
            category: {
              type: "string",
              description: "Category of fixes to preview",
            },
            file: {
              type: "string",
              description: "Preview fixes for specific file only",
            },
          },
        },
      },
      {
        name: "wp_doctor_apply_fixes",
        description:
          "Apply safe, auto-fixable corrections to detected issues. Creates backups before modifying files. Use with caution.",
        inputSchema: {
          type: "object",
          properties: {
            path: {
            ...
            category: {
              type: "string",
              description: "Category of fixes to apply",
            },
            file: {
              type: "string",
              description: "Apply fixes to specific file only",
            },
          },
        },
      },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    switch (name) {
        ...
        if (!result.success) {
          return {
            content: [
              {
                type: "text",
                text: `Error getting info: ${result.error}`,
              },
            ],
          };
        }
      ...
      case "wp_doctor_apply_fixes": {
        let command = "doctor fix --yes";
